...
typedef bf_pltfm_status_t (*bf_pltfm_bd_cfg_qsfp_type_fn)(
 ...
 *
 */
bf_pltfm_status_t bf_bd_cfg_rtmr_info_get(bf_pltfm_port_info_t *port_info,
 ...
 */
bf_pltfm_status_t bf_bd_cfg_port_info_get(uint32_t mac_id,
                                          uint32_t mac_chnl_id,
                                          bf_pltfm_port_info_t *port_info);
 ...
 */
bf_pltfm_status_t bf_bd_cfg_port_tx_pn_swap_get(bf_pltfm_port_info_t *port_info,
                                                bool *tx_phy_pn_swap);
 ...
 * connected to the port on the board
 */
bf_pltfm_status_t bf_bd_cfg_port_rx_pn_swap_get(bf_pltfm_port_info_t *port_info,
                                                bool *rx_phy_pn_swap);
...
#ifdef INC_PLTFM_UCLI
ucli_node_t *bf_bd_cfg_ucli_node_create(ucli_node_t *m);
#endif

/*
 * bf_bd_cfg_qsfp_type_fn_reg
 */
bf_pltfm_status_t bf_bd_cfg_qsfp_type_fn_reg(bf_pltfm_bd_cfg_qsfp_type_fn fn);
...
bf_pltfm_status_t bf_bd_cfg_port_is_multilane_channel_get(
    bf_pltfm_port_info_t *port_info, bool *is_multi_lane_conn);

bf_pltfm_status_t bf_bd_cfg_qsfp_ch_get(bf_pltfm_port_info_t *port_info,
                                        uint32_t *qsfp_ch);

bf_pltfm_status_t bf_bd_cfg_pin_name_get(bf_pltfm_port_info_t *port_info,
                                         char *pin_name);
#ifdef __cplusplus
}
#endif /* C++ */
