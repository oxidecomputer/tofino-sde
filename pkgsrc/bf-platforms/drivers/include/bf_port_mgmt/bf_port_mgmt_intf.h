...
bf_status_t qsfp_lpmode_sw_set(bf_dev_id_t dev_id, int conn_id, bool val);
...
void qsfp_state_ha_enable_config_delete(int conn_id, int ch);

void qsfp_state_ha_enable_config_set(int conn_id, int ch);
