 ...
 * @return Status of the API call
 */
bf_status_t bf_pm_pre_port_delete_cfg_set(bf_pal_front_port_handle_t *port_hdl,
                                          bf_pal_front_port_cb_cfg_t *port_cfg);
 ...
 * @return Status of the API call
 */
bf_status_t bf_pm_pre_port_enable_cfg_set(bf_pal_front_port_handle_t *port_hdl,
                                          bf_pal_front_port_cb_cfg_t *port_cfg);
...
/**
 * @brief Return the presence-detect bit of the cable connected to a port
 *
 * @param port_hdl Identifier of the port on the system
 * @param presence Presence-detect status
 *
 * @return Status of the API call
 */
